...
from easy_io.backends import backends, prefix_to_backends
from easy_io.file_client import FileClient
from easy_io.handlers import file_handlers
            ...
            with BytesIO() as f:
                ...
                if fast_backend:
                    if hasattr(file_backend, "fast_put"):
                        ...
                        warnings.warn(
                            "fast_backend is not supported by the backend, fallback to normal put", stacklevel=2
                        )
